...
<div class="w3-center w3-black w3-margin w3-padding">
	<form action="employeea.php" class="w3-margin w3-padding" method="POST">
		<button class="w3-button w3-green w3-xxlarge" type="submit">Add new employee</button>
	</form>
	<form action="employeed.php" class="w3-margin w3-padding" method="POST">
		<button class="w3-button w3-green w3-xxlarge" type="submit">update employee details</button>
	</form>
	<form action="employeedet.php" class="w3-margin w3-padding" method="POST">
		<button class="w3-button w3-green w3-xxlarge" type="submit">show employee details</button>
	</form>
</div>
</div>
	<?php  
		...
		while ($row=$p->fetch()) {
			...
			$req1=6-$count1;
			$req2=6-$count2;
			echo '<div class="w3-center"><h1 class="w3-container w3-black w3-margin w3-padding">Total room service employees required : '.$req1.'<br>Total restuarent employees required : '.$req2.'</h1>';
		}
	?>
</body>
</html>
